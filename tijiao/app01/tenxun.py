...
def send_txy_yzm(yzm, phone_num):
    ...
    try:
        ...
        cred = credential.Credential("AKID9sUwTqitOk0ZbYigZO5Zy22ZYRMJMkxF", "R8jrpcJ5qdGifZxJix9A1JRIRdeUA4Ov")
