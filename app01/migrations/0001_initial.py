# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-12-25 01:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money', models.DecimalField(decimal_places=2, default=10.0, max_digits=12)),
                ('user_ico', models.FileField(default='user_ico/01default.jpg', upload_to='user_ico/%Y/')),
                ('is_ban', models.BooleanField(default=0)),
                ('qianming', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='Wenzhang',
        ...
        migrations.AddField(
            model_name='user',
            name='wenzhang',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Wenzhang'),
        ),
        migrations.AddField(
            model_name='files',
            name='user',
